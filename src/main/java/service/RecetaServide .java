...
public class RecetaServide {
    ...
    private void cargarDatosDePrueba() {
        productos.add(new Producto(1, "Hamburguesa Clásica", 18000));
        productos.add(new Producto(2, "Pizza Margarita", 25000));
        productos.add(new Producto(3, "Limonada", 6000));
        productos.add(new Producto(4, "Pato a la naranja", 45000));
        ...
        // Recetas precargadas, para poder probar la precuenta sin pasos previos
        Receta recetaHamburguesa = new Receta(buscarProductoPorId(1));
        recetaHamburguesa.agregarIngrediente(buscarIngredientePorId(10), 1);
        recetaHamburguesa.agregarIngrediente(buscarIngredientePorId(11), 150);
        recetaHamburguesa.agregarIngrediente(buscarIngredientePorId(12), 30);
        recetasPorProducto.put(1, recetaHamburguesa);
